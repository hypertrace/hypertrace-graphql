...
import org.hypertrace.graphql.spanprocessing.request.mutation.IncludeSpanDeleteRuleRequestBuilder;
import org.hypertrace.graphql.spanprocessing.schema.mutation.DeleteSpanProcessingRuleResponse;

public class IncludeSpanDeleteRuleMutator
    extends InjectableDataFetcher<DeleteSpanProcessingRuleResponse> {

  public IncludeSpanDeleteRuleMutator() {
    super(IncludeSpanDeleteRuleMutatorImpl.class);
  }

  static final class IncludeSpanDeleteRuleMutatorImpl
    ...
    private final IncludeSpanDeleteRuleRequestBuilder requestBuilder;

    @Inject
    IncludeSpanDeleteRuleMutatorImpl(
        IncludeSpanDeleteRuleRequestBuilder requestBuilder,
    ...
    public CompletableFuture<DeleteSpanProcessingRuleResponse> get(
      ...
      return this.requestBuilder
          ...
          .flatMap(this.spanProcessingRuleDao::deleteIncludeSpanRule)
          .toCompletionStage()
          .toCompletableFuture();
    }
  }
